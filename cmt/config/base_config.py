    ...
    def add_datasets(self):
        datasets = [
            ...
            Dataset("bbtt_ggf_hlt",
                "/eos/user/j/jleonhol/HH/hlt/Run3/GluGluToHHTo2B2Tau_node_cHHH1_TuneCP5_14TeV-powheg-pythia8",
                self.processes.get("ggf_sm"),
                hlt=True),
            Dataset("bbtt_vbf_hlt",
                "/eos/home-j/jleonhol/HH/hlt/Run3/VBFHHTo2B2Tau_CV_1_C2V_1_C3_1_TuneCP5_14TeV-madgraph-pythia8",
                self.processes.get("vbf_sm"),
                hlt=True),
            Dataset("htautau_ggf",
            ...
            Dataset("htt_ggf_hlt",
                "/eos/user/j/jleonhol/HH/hlt/Run3/GluGluHToTauTau_M-125_TuneCP5_14TeV-powheg-pythia8",
                self.processes.get("htautau_ggf"),
                hlt=True),
            Dataset("htt_vbf_hlt",
                "/eos/home-j/jleonhol/HH/hlt/Run3/VBFHToTauTau_M125_TuneCP5_14TeV-powheg-pythia8",
            ...
            Dataset("ephemeral_hlt",
                "/eos/home-j/jleonhol/HH/hlt/EphemeralZeroBias/",
